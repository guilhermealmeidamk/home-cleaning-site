    ...
    <>
      ...
      <div className="relative z-10 mx-auto flex min-h-[78vh] max-w-5xl flex-col px-6 pt-32 pb-8 md:pt-0 md:pb-0">
        <div className="flex flex-1 flex-col items-center justify-center text-left">
          <div className="mb-5 flex w-full items-center justify-center gap-4 text-primary/90">
          ...
          <h1 className="max-w-4xl text-4xl font-extrabold tracking-tight text-primary md:text-6xl">
          ...
          <div className="mt-8 mb-6 flex flex-col items-center gap-3 md:mb-0">
            ...
            <a
              href={smsHref}
              className="inline-block rounded-full border border-primary/50 bg-tertiary/10 px-10 py-3 font-bold text-primary transition-colors hover:bg-tertiary/40"
            >
              Text Us
            </a>
          </div>
        ...
        <div className="mx-auto mb-4 flex w-full max-w-2xl items-center justify-center gap-3 rounded-xl bg-primary/20 px-3 py-3 backdrop-blur-[1px] md:mb-8 md:gap-5">
          <div className="flex items-center">
            <span className="inline-flex h-9 w-9 items-center justify-center rounded-full border border-primary/65 bg-[#98b89c] text-sm font-semibold text-primary">
              JM
            </span>
            <span className="-ml-1.5 inline-flex h-9 w-9 items-center justify-center rounded-full border border-primary/65 bg-[#4f8a4d] text-sm font-semibold text-primary">
              AL
            </span>
            <span className="-ml-1.5 inline-flex h-9 w-9 items-center justify-center rounded-full border border-primary/65 bg-[#ddd3b2] text-sm font-semibold text-primary">
              RP
            </span>
            <span className="-ml-1.5 inline-flex h-9 w-9 items-center justify-center rounded-full border border-primary/65 bg-[#b9ceb8] text-lg font-semibold text-primary">
              +
            </span>
          </div>
          <div className="text-center md:text-left">
            <div className="mb-1 flex justify-center gap-1 text-primary md:justify-start">
              {[...Array(5)].map((_, index) => (
            ...
            <p className="text-base leading-tight text-primary font-semibold md:text-lg">
